...
| **RobOS Session Context Waste Detector & Inspector** | [raw note](https://github.com/nddipiazza/robos/blob/main/docs/ideas/inbox/robos-session-context-waste-detector.txt) | [feature spec](https://github.com/nddipiazza/robos/blob/main/docs/ideas/specs/robos-session-context-waste-detector.md) | `packages/agents-manager`, `packages/robos-lib`, `packages/agent-chat`, `packages/dev-central`, `packages/robos-graph` |
